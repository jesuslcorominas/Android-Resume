 ...
 */
@Entity
public class TrainingObjectBoxEntity extends AbstractObjectBoxBaseEntity {
    ...
    public static class TrainingComparator implements Comparator<TrainingObjectBoxEntity> {
        @Override
        public int compare(TrainingObjectBoxEntity o1, TrainingObjectBoxEntity o2) {
            if (o1 == null) {
